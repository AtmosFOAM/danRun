...
FROM=/media/daniel/STORAGE/OpenFOAM-run/danRun/partitioned/RayleighBenard/Ra_1e+05_multiFluidBoussinesqFoam_hiRes_lowB/timeMean

values=`awk '{if(NR>1)print $2}' $FROM/horizontalMean_falling_none_sigma.dat | paste -s`
