...
# add random noise perturbation to theta field
postProcess -func randomise -time 0
mv 0/theta 0/theta_initSine
...
postProcess -func "grad(theta)" -time "160:"
writeCellDataxyz u -time "160:"
writeCellDataxyz theta -time "160:"
writeCellDataxyz "grad(theta)" -time "160:"
writeCellDataxyz rho -time "160:"
