...
# clear out old stuff
rm -rf [0-9]* constant/polyMesh core log energy.dat gmt.* postProcessing legends *.OpenFOAM
...
# calculate heat flux over last 30 secs of simulation
for time in {230..250..1}; do
