...
def plotTheta():
    # load data
    files = ("horizontalMean_rho_theta.dat",
             "horizontalMean_falling_rho_theta.dat",
             "horizontalMean_rising_rho_theta.dat")
   ...
   # 
    ...
    # just the mean
    plt.figure()
    plt.plot(mean[1:,1],mean[1:,0],'k',label="mean")
    #plt.fill_betweenx(mean[:,0],mean[:,2],x2=mean[:,3], color='k', alpha=0.1, 
    #                  label="+/- 1 std. dev.")
    #plt.fill_betweenx(mean[:,0],mean[:,4],x2=mean[:,5], color='k', alpha=0.05,
    #                  label="min./max.")
...
def plotVerticalVelocity():
    # load data
    files = ("horizontalMean_rho_uz.dat",
             "horizontalMean_falling_rho_uz.dat",
             "horizontalMean_rising_rho_uz.dat")
    mean = np.loadtxt(files[0],usecols = (0,1))#3,4,5,6,7))
    mean_falling = np.loadtxt(files[1],usecols = (0,1))#3,4,5,6,7))
    mean_rising = np.loadtxt(files[2],usecols = (0,1))#3,4,5,6,7))
...
def plotExner():
    files = ("horizontalMean_rho_Exner.dat",
             "horizontalMean_falling_rho_Exner.dat",
             "horizontalMean_rising_rho_Exner.dat")
    mean = np.loadtxt(files[0],usecols = (0,1))#3,4,5,6,7))
    mean_falling = np.loadtxt(files[1],usecols = (0,1))#3,4,5,6,7))
    mean_rising = np.loadtxt(files[2],usecols = (0,1))#3,4,5,6,7))
    ...
    plt.ylabel(r"$z$ (m)")
    plt.legend(loc="best")
    plt.savefig("Exner_profile_conditioned.png")
    plt.show()
    plt.close()
...
def plotPressure():
    # load data
    files = ("horizontalMean_rho_P.dat",
             "horizontalMean_falling_rho_P.dat",
             "horizontalMean_rising_rho_P.dat")
    mean = np.loadtxt(files[0],usecols = (0,3,4,5,6,7))
    mean_falling = np.loadtxt(files[1],usecols = (0,3,4,5,6,7))
    mean_rising = np.loadtxt(files[2],usecols = (0,3,4,5,6,7))
